...
public class AudioTaskCreationParameter
		implements
		org.apache.thrift.TBase<AudioTaskCreationParameter, AudioTaskCreationParameter._Fields>,
		java.io.Serializable, Cloneable, Comparable<AudioTaskCreationParameter> {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"AudioTaskCreationParameter");
	...
	private static final org.apache.thrift.protocol.TField RETRY__FIELD_DESC = new org.apache.thrift.protocol.TField(
			"retry_", org.apache.thrift.protocol.TType.I16, (short) 4);

	private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
	static {
		schemes.put(StandardScheme.class,
				new AudioTaskCreationParameterStandardSchemeFactory());
		schemes.put(TupleScheme.class,
				new AudioTaskCreationParameterTupleSchemeFactory());
	}
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		RECEIVERS((short) 1, "receivers"), MESSAGE((short) 2, "message"), SENDER_KEY(
				(short) 3, "sender_key"), RETRY_((short) 4, "retry_");
	...
	private static final int __RETRY__ISSET_ID = 0;
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				AudioTaskCreationParameter.class, metaDataMap);
	}

	public AudioTaskCreationParameter() {
	}

	public AudioTaskCreationParameter(String receivers, String message,
			String sender_key) {
		this();
	 ...
	 */
	public AudioTaskCreationParameter(AudioTaskCreationParameter other) {
	...
	public AudioTaskCreationParameter deepCopy() {
		return new AudioTaskCreationParameter(this);
	}
	...
	public AudioTaskCreationParameter setReceivers(String receivers) {
		this.receivers = receivers;
		return this;
	}
	...
	public AudioTaskCreationParameter setMessage(String message) {
		this.message = message;
		return this;
	}
	...
	public AudioTaskCreationParameter setSender_key(String sender_key) {
		this.sender_key = sender_key;
		return this;
	}
	...
	public AudioTaskCreationParameter setRetry_(short retry_) {
		this.retry_ = retry_;
		setRetry_IsSet(true);
		return this;
	}
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof AudioTaskCreationParameter)
			return this.equals((AudioTaskCreationParameter) that);
		return false;
	}

	public boolean equals(AudioTaskCreationParameter that) {
		if (that == null)
			return false;
	...
	public int compareTo(AudioTaskCreationParameter other) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("AudioTaskCreationParameter(");
		boolean first = true;
	...
	private static class AudioTaskCreationParameterStandardSchemeFactory
			implements SchemeFactory {
		public AudioTaskCreationParameterStandardScheme getScheme() {
			return new AudioTaskCreationParameterStandardScheme();
		}
	}

	private static class AudioTaskCreationParameterStandardScheme extends
			StandardScheme<AudioTaskCreationParameter> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				AudioTaskCreationParameter struct)
				throws org.apache.thrift.TException {
	...
	private static class AudioTaskCreationParameterTupleSchemeFactory implements
			SchemeFactory {
		public AudioTaskCreationParameterTupleScheme getScheme() {
			return new AudioTaskCreationParameterTupleScheme();
		}
	}

	private static class AudioTaskCreationParameterTupleScheme extends
			TupleScheme<AudioTaskCreationParameter> {
