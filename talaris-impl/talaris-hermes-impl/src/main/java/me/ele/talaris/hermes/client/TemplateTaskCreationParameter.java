...
public class TemplateTaskCreationParameter
		implements
		org.apache.thrift.TBase<TemplateTaskCreationParameter, TemplateTaskCreationParameter._Fields>,
		java.io.Serializable, Cloneable,
		Comparable<TemplateTaskCreationParameter> {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"TemplateTaskCreationParameter");
	...
	private static final org.apache.thrift.protocol.TField TEMPLATE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"template_id", org.apache.thrift.protocol.TType.I64, (short) 2);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		RECEIVERS((short) 1, "receivers"), TEMPLATE_ID((short) 2, "template_id"), TEMPLATE_PARAMS(
				(short) 3, "template_params"), SENDER_KEY((short) 4,
				"sender_key"), NEED_REPLY((short) 5, "need_reply"), RETRY_(
				(short) 6, "retry_");
	...
	private static final int __TEMPLATE_ID_ISSET_ID = 0;
	private static final int __NEED_REPLY_ISSET_ID = 1;
	private static final int __RETRY__ISSET_ID = 2;
	...
	static {
		...
		tmpMap.put(_Fields.TEMPLATE_ID,
				new org.apache.thrift.meta_data.FieldMetaData("template_id",
						org.apache.thrift.TFieldRequirementType.REQUIRED,
						new org.apache.thrift.meta_data.FieldValueMetaData(
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				TemplateTaskCreationParameter.class, metaDataMap);
	}

	public TemplateTaskCreationParameter() {
	}

	public TemplateTaskCreationParameter(String receivers, long template_id,
			String template_params, String sender_key) {
		this();
	 ...
	 */
	public TemplateTaskCreationParameter(TemplateTaskCreationParameter other) {
	...
	public TemplateTaskCreationParameter deepCopy() {
		return new TemplateTaskCreationParameter(this);
	}
	...
	public TemplateTaskCreationParameter setReceivers(String receivers) {
		this.receivers = receivers;
		return this;
	}
	...
	public TemplateTaskCreationParameter setTemplate_id(long template_id) {
		this.template_id = template_id;
		setTemplate_idIsSet(true);
		return this;
	}
	...
	public void unsetTemplate_id() {
		__isset_bitfield = EncodingUtils.clearBit(__isset_bitfield,
				__TEMPLATE_ID_ISSET_ID);
	}

	/**
	 * Returns true if field template_id is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public TemplateTaskCreationParameter setTemplate_params(
	...
	/**
	 * Returns true if field template_params is set (has been assigned a value)
	 * and false otherwise
	 */
	...
	public TemplateTaskCreationParameter setSender_key(String sender_key) {
		this.sender_key = sender_key;
		return this;
	}
	...
	public TemplateTaskCreationParameter setNeed_reply(boolean need_reply) {
	...
	public TemplateTaskCreationParameter setRetry_(short retry_) {
		this.retry_ = retry_;
		setRetry_IsSet(true);
		return this;
	}
	...
	public Object getFieldValue(_Fields field) {
		...
		case TEMPLATE_ID:
			return Long.valueOf(getTemplate_id());
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof TemplateTaskCreationParameter)
			return this.equals((TemplateTaskCreationParameter) that);
		return false;
	}

	public boolean equals(TemplateTaskCreationParameter that) {
		if (that == null)
			return false;
		...
		boolean this_present_template_id = true;
		boolean that_present_template_id = true;
	...
	public int hashCode() {
		...
		boolean present_template_id = true;
	...
	public int compareTo(TemplateTaskCreationParameter other) {
		...
		lastComparison = Boolean.valueOf(isSetTemplate_id()).compareTo(
				other.isSetTemplate_id());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetTemplate_id()) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("TemplateTaskCreationParameter(");
		boolean first = true;
	...
	public void validate() throws org.apache.thrift.TException {
		...
		// alas, we cannot check 'template_id' because it's a primitive and you
		// chose the non-beans generator.
		if (template_params == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'template_params' was not present! Struct: "
							+ toString());
		}
		if (sender_key == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
	...
	private static class TemplateTaskCreationParameterStandardSchemeFactory
			implements SchemeFactory {
		public TemplateTaskCreationParameterStandardScheme getScheme() {
			return new TemplateTaskCreationParameterStandardScheme();
		}
	}

	private static class TemplateTaskCreationParameterStandardScheme extends
			StandardScheme<TemplateTaskCreationParameter> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				TemplateTaskCreationParameter struct)
				throws org.apache.thrift.TException {
			...
			while (true) {
				...
				case 2: // TEMPLATE_ID
					if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
						struct.template_id = iprot.readI64();
			...
			if (!struct.isSetTemplate_id()) {
				throw new org.apache.thrift.protocol.TProtocolException(
						"Required field 'template_id' was not found in serialized data! Struct: "
								+ toString());
			}
			struct.validate();
		}
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot,
			...
			oprot.writeI64(struct.template_id);
			oprot.writeFieldEnd();
	...
	private static class TemplateTaskCreationParameterTupleSchemeFactory
			implements SchemeFactory {
		public TemplateTaskCreationParameterTupleScheme getScheme() {
			return new TemplateTaskCreationParameterTupleScheme();
		}
	}

	private static class TemplateTaskCreationParameterTupleScheme extends
			TupleScheme<TemplateTaskCreationParameter> {
