...
public class THermesTemplateTask
		implements
		org.apache.thrift.TBase<THermesTemplateTask, THermesTemplateTask._Fields>,
		java.io.Serializable, Cloneable, Comparable<THermesTemplateTask> {
	...
	private static final org.apache.thrift.protocol.TField TEMPLATE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"template_id", org.apache.thrift.protocol.TType.I64, (short) 7);
	...
	private static final org.apache.thrift.protocol.TField RETRY__FIELD_DESC = new org.apache.thrift.protocol.TField(
			"retry_", org.apache.thrift.protocol.TType.I16, (short) 9);

	private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
	static {
		schemes.put(StandardScheme.class,
				new THermesTemplateTaskStandardSchemeFactory());
		schemes.put(TupleScheme.class,
				new THermesTemplateTaskTupleSchemeFactory());
	}
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		...
		STATUS((short) 4, "status"), CREATE_TIME((short) 5, "create_time"), NEED_REPLY(
				(short) 6, "need_reply"), TEMPLATE_ID((short) 7, "template_id"), TEMPLATE_PARAMS(
				(short) 8, "template_params"), RETRY_((short) 9, "retry_");
	...
	private static final int __RETRY__ISSET_ID = 5;
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				THermesTemplateTask.class, metaDataMap);
	}

	public THermesTemplateTask() {
	}

	public THermesTemplateTask(long id, boolean mass_send, String receivers,
			THermesTaskStatus status, long create_time, boolean need_reply,
			long template_id, String template_params) {
		this();
		this.id = id;
		setIdIsSet(true);
	 ...
	 */
	public THermesTemplateTask(THermesTemplateTask other) {
	...
	public THermesTemplateTask deepCopy() {
		return new THermesTemplateTask(this);
	}
	...
	public THermesTemplateTask setId(long id) {
		this.id = id;
		setIdIsSet(true);
		return this;
	}
	...
	public THermesTemplateTask setMass_send(boolean mass_send) {
		this.mass_send = mass_send;
		setMass_sendIsSet(true);
		return this;
	}
	...
	public THermesTemplateTask setReceivers(String receivers) {
		this.receivers = receivers;
		return this;
	}
	 ...
	 * @see THermesTaskStatus
	 */
	public THermesTemplateTask setStatus(THermesTaskStatus status) {
		this.status = status;
		return this;
	}
	...
	public THermesTemplateTask setCreate_time(long create_time) {
		this.create_time = create_time;
		setCreate_timeIsSet(true);
		return this;
	}
	...
	public THermesTemplateTask setNeed_reply(boolean need_reply) {
		this.need_reply = need_reply;
		setNeed_replyIsSet(true);
		return this;
	}
	...
	public THermesTemplateTask setTemplate_id(long template_id) {
		this.template_id = template_id;
		setTemplate_idIsSet(true);
		return this;
	}
	...
	public THermesTemplateTask setTemplate_params(String template_params) {
		this.template_params = template_params;
		return this;
	}
	...
	public THermesTemplateTask setRetry_(short retry_) {
		this.retry_ = retry_;
		setRetry_IsSet(true);
		return this;
	}
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof THermesTemplateTask)
			return this.equals((THermesTemplateTask) that);
		return false;
	}

	public boolean equals(THermesTemplateTask that) {
		if (that == null)
			return false;
	...
	public int compareTo(THermesTemplateTask other) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("THermesTemplateTask(");
		boolean first = true;
	...
	private static class THermesTemplateTaskStandardSchemeFactory implements
			SchemeFactory {
		public THermesTemplateTaskStandardScheme getScheme() {
			return new THermesTemplateTaskStandardScheme();
		}
	}

	private static class THermesTemplateTaskStandardScheme extends
			StandardScheme<THermesTemplateTask> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				THermesTemplateTask struct) throws org.apache.thrift.TException {
	...
	private static class THermesTemplateTaskTupleSchemeFactory implements
			SchemeFactory {
		public THermesTemplateTaskTupleScheme getScheme() {
			return new THermesTemplateTaskTupleScheme();
		}
	}

	private static class THermesTemplateTaskTupleScheme extends
			TupleScheme<THermesTemplateTask> {
